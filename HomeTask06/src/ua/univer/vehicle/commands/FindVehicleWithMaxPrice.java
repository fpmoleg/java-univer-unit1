...
public class FindVehicleWithMaxPrice extends Command {
	
	public FindVehicleWithMaxPrice(VehicleList input, VehicleList output) {
		super(input, output);
	}
	...
	public String toString() {
		return "Display a vehicle with the biggest price:";
	}
}
